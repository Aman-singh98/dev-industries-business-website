...
import otTableBg from "/images/products/ot-table/OT_TABLE_ELECTRIC_TOP_SLIDE.jpg"; // 🔁 swap path as needed

const OTTableHeroSection = () => {
	return (
		<section
			className="
        relative
      ...
      "
		>
			...
			<div
				...
				style={{ backgroundImage: `url(${otTableBg})` }}
			/>

			{/* Dark gradient overlay — stronger at edges, lighter at center */}
        ...
        "
          ...
          "
				>
					Engineered for demanding surgical environments — our OT tables offer
					unmatched stability, multi-position control, and hygienic
					stainless-steel construction trusted across India's leading hospitals
					since 2013.
				</motion.p>
				...
				>
					{["Motorised Controls", "Radiolucent Top", "Anti-Rust Steel", "ISO Certified"].map(
						(tag, i) => (
							<span
								key={i}
								className="
...
export default OTTableHeroSection;